...
You can invoke this skill when:
...
- **Secondary Color**: #E2E8F0 (HSL 220 14% 92%)
- **Brand Red**: #D50F17
- **Brand Yellow**: #FFDB4A
- **Typography**: Satoshi (Sans), Edo (Display), Permanent Marker (Emphasis), Mono (Labels)
- **Style**: Mechanical Industrial, Blueprint Grids, High Contrast.
