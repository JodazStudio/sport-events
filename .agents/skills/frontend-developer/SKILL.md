...
- Next.js 15 App Router with Server Components (**Default**) and Client Components (**Leaves only**)
- React Server Components (RSC) and **Streaming with Suspense**
- Server Actions for seamless client-server data mutations with **End-to-End Type Safety**
- Advanced routing with parallel routes, intercepting routes, and route handlers
- Incremental Static Regeneration (ISR) and dynamic rendering
- Edge runtime and middleware configuration
- **SEO**: Dynamic metadata with `generateMetadata` and Image optimization with `next/image`
- API routes and serverless function patterns

### Modern Frontend Architecture
- **Maintainability**: Feature-driven development using a `features/` directory
...
- **Data Validation**: Mandates **Zod** for all external and internal data boundaries
...
- Implements proper SEO and dynamic meta tag management with **`generateMetadata`**
...
8. **Optimize for Core Web Vitals** and user experience
