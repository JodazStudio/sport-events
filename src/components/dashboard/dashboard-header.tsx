...
export function DashboardHeader() {
  ...
  const { role, impersonatedAdminId, logout } = useAuthStore();
  ...
  const superadminNavItems = [
    { title: "Managers", url: "/dashboard/superadmin/managers", icon: Users },
        ...
        <div className="flex items-center gap-3 ml-auto">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="relative h-9 w-9 rounded-none border border-border p-0 bg-muted hover:bg-muted/80">
            ...
            <DropdownMenuContent align="end" className="w-56 rounded-none border-2 border-border shadow-[4px_4px_0px_0px_rgba(0,0,0,0.1)]">
              <DropdownMenuLabel className="font-satoshi uppercase italic font-bold">Mi Cuenta</DropdownMenuLabel>
              <DropdownMenuSeparator />
